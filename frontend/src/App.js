          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px', marginTop: '20px' }}>
            ...
            <div>
              ...
              <div style={{ 
                ...
                <h4 style={{ color: '#2c3e50', marginBottom: '1rem' }}>Sample Input Form</h4>
                <p style={{ color: '#666', fontSize: '0.9rem', lineHeight: '1.6' }}>
                  The interactive prediction form would be displayed here, allowing users to input team statistics 
                  and receive AI-powered match outcome predictions. The form includes fields for kills, digs, 
                  errors, and aces for both teams.
                </p>
                <div style={{ 
                  marginTop: '1rem', 
                  padding: '1rem', 
